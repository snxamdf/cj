...
public class BehanceSearch37Collector extends BehanceSearchsCollector {
	@Override
	public void begin() {
		// 默认注入的配置
		...
		if (config == null) {// 开发时用到的，自己配置
			...
			config.setSiteUrl("https://www.behance.net/search?field=37&content=projects&sort=appreciations&time=week");
